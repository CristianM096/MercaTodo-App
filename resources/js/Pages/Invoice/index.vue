    ...
    <BreezeAuthenticatedLayout>
        ...
        <div>
            <section class="py-1 bg-blueGray-50">
                <div class="w-full xl:w-8/12 mb-12 xl:mb-0 px-4 mx-auto mt-24">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                        ...
                        <div class="flex flex-wrap items-center">
                            ...
                            <h3 class="font-semibold text-base text-blueGray-700">Purchase History</h3>
                            </div>
                        ...
                        <table class="items-center bg-transparent w-full border-collapse ">
                            ...
                            <tbody>
                                    <tr v-for="(invoice,index) in invoices.data" :key="index"> 
                                        ...
                                        <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left text-blueGray-700 ">
                                            {{invoice.total}}</td>
                                        <td class="flex border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center text-blueGray-700 ">
                                            pay here:
                                            <a :href="invoice.payment_url" type="button">
                ...
                <pagination class="mt-6 flex justify-center" :links="invoices.links" />
            </section>
        </div>
